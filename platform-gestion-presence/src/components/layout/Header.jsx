...
export default function Header({ onMenu }) {
  ...
  const title = titles[pathname] || (pathname.startsWith('/cours/programme') ? 'Programme de classe' : 'Présence')
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-white/50 bg-white/90 px-4 shadow-[0_10px_30px_rgba(15,23,42,0.08)] backdrop-blur-sm lg:px-6">
